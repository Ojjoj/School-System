...
<head>
    ...
    <link href="../../css/view_teacher.css" rel="stylesheet">
</head>
            ...
            <div class="container mt-3">
                ...
                <div class="row me-3">
                    <div class="mb-3">
                        ...
                        <hr>
                        <p class="info"><?php echo $job_description ? $job_description : "Not available"; ?></p>
                    </div>
                </div>
                <br>
                <center>
                    <a href="teacher.php" class="btn btn-primary">Back to Teachers List</a>
                </center>
                <br>
            </div>
        </div>
